...
@section('contents')
  <div class="header-bg">
					...
					<div class="col-lg-4 col-md-6">
					 <div class="card h-100">
						 <div class="single-post post-style-1">
							 <div class="blog-image"><img src="{{asset('uploads/post/'.$randompost->image)}}" alt="{{ $randompost->title }}" style="height:200px"></div>

 							<a class="avatar" href="#"><img src="{{asset('uploads/adminprofile/'.$randompost->user->image)}}" alt="Profile Image"></a>

							 <div class="blog-info">

								 <h4 class="title"><a href="{{ route('post.details',$post->slug) }}"><b>{{ $randompost->title }}</b></a></h4>
									 ...
									 <li>
	 									...
	 									@else
	 										<a href="javascript:void(0);" onclick="document.getElementById('favorite-form-{{ $randompost->id }}').submit();"
	 											class="{{ !Auth::user()->favorite_posts->where('pivot.post_id',$randompost->id)->count() == 0 ?
	 											'favorite_posts' : '' }}">
	 											<i class="ion-heart"></i>{{ $randompost->favorite_to_users->count() }}</a>
	...
	<section class="comment-section">
		<div class="container">
			<h4><b>POST COMMENT ({{ $post->comments->count() }})</b></h4>
			<div class="row">
