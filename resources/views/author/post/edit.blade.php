                       ...
                       <div class="body">
                               ...
                               <div class="form-group form-float">
                                   <div class="form-line {{ $errors->has('categories') ? 'focused error' : '' }}">
                                       ...
                                       <select class="form-control show-tick" id="category" name="categories[]" data-live-search="true" multiple>
                               ...
                               <div class="form-group form-float">
                                   <div class="form-line {{ $errors->has('tags') ? 'focused error' : '' }}" >
                                       ...
                                       <select class="form-control show-tick" id="tag" name="tags[]" data-live-search="true" multiple>
                                          @foreach ($tags as $tag)
                                            <option
