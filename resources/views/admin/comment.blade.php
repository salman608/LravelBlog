                            ...
                            @foreach ($comments as $comment)
                              ...
                              <tr>
                               <td>
                                    ...
                                    <a href="#"><img class="media-object" src="{{asset('uploads/adminprofile/'.$comment->user->image)}}" style="width:64px;height:64px"></a>
                               </div>
                               <div class="media-body">
                                    <h4 class="media-heading">{{ $comment->user->name }} <small>{{ $comment->created_at->format('d M Y') }}</small> </h4>
                                    <p>{{ $comment->comment }}</p>
                              ...
                              <div class="media">
                                   <div class="media-right">
                                        ...
                                        <img class="media-object" src="{{asset('uploads/post/'.$comment->post->image)}}" style="width:64px;height:64px">
                                        </a>
                                   </div>
                                   <div class="media-body">
                                         <a href="{{ route('post.details',$comment->post->slug) }}">
